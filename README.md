...
This repo is a fork of [thorinside/grid-cli](https://github.com/thorinside/grid-cli), which is the easiest way I could find to flash multiple modules at once. Plug in any number of connected BU16 modules and run:
